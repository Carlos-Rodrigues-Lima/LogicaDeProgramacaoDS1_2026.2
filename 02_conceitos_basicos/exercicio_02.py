...
distancia = int (input("qual a distancia total da sua viagem"))
consumo = int (input(" quantos litros a motoca bebeu"))
lPorKm = distancia/consumo
print (f"sua da kawasaki bebe {lPorKm:.2f}  Litros por Km ")